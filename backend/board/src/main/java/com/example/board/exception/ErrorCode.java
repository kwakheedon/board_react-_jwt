...
public enum ErrorCode {
    ...
    NICKNAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "M003", "이미 사용중인 닉네임입니다."),
    LOGIN_FAIL(HttpStatus.UNAUTHORIZED, "M004", "이메일 또는 비밀번호가 일치하지 않습니다."),
    POST_NOT_FOUND(HttpStatus.UNAUTHORIZED, "M005", "해당 게시글을 찾을 수 없습니다."),
    POST_NOT_UPDATE(HttpStatus.UNAUTHORIZED, "M006", "수정권한이 없습니다."),
    DELETE_NOT_UPDATE(HttpStatus.UNAUTHORIZED, "M007", "게시글 삭제 권한이 없습니다."),
